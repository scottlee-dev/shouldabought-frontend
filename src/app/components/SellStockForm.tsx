...
export default function SellStockForm() {
  ...
  return (
    <form
      ...
      className="mt-4 rounded-2xl border border-gray-800 bg-gray-900 p-6"
    >
      ...
      <div className="mt-5 flex flex-col gap-4 md:flex-row">
        ...
        <button
          type="submit"
          disabled={loading}
          className="rounded-lg bg-red-500 px-6 py-3 font-semibold text-white disabled:opacity-50"
        >
